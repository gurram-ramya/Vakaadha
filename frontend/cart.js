...
// function renderCartItems(items, token) {
...
//         <button onclick="updateQuantity(${item.cart_id}, ${item.quantity + 1})">+</button>
//         <button onclick="removeItem(${item.cart_id})" class="remove-btn">Remove</button>
//       </div>
//       <hr/>
//     `;
...
//       img: item.querySelector("img").getAttribute("src").split("/").pop()  // Get image file name
//     });
//   });
